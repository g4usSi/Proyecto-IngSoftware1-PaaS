...
export function StoragePage() {
  return (
    <>
      <div className="page-heading"><div><span className="eyebrow">BIBLIOTECA</span><h1>Mis imágenes</h1><p>Un lugar para guardar lo que creas.</p></div><button type="button" className="button button-dark" disabled aria-describedby="upload-pending"><Icon name="upload" /> Subir imagen</button></div>
      ...
      <div className="storage-explainer"><span className="explainer-icon"><Icon name="layers" /></span><div><h2>Menos copias, el mismo espacio personal.</h2><p>Guardaremos una única versión WebP por contenido idéntico. Cada usuario conservará sus propios permisos de acceso.</p></div></div>
    </>
  );
}
